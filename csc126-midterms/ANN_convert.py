...
folder_path = "input_images"#path for raw images such as wriiten digits
extensions = ['.jpg', '.jpeg', '.png'] #list of valid image file extensions

if not os.path.exists("ANN_debug_images"): ##creates file for a debugger
    os.makedirs("ANN_debug_images")
...
for file in os.listdir(folder_path):
    ...
    ANN_image_path = os.path.join("ANN_debug_images", file) 
